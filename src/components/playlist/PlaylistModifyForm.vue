<template>
    <div>
        <v-form @submit.prevent="onSubmit" ref="form">
            <v-card-title class="playlist-dialog-title">플레이리스트 수정</v-card-title>
            <v-text-field id="playlist-title" type="text" v-model="playlist.playlistName" placeholder="제목을 입력하세요"
            ...
            <div class="add-button">
                <v-btn @click="onSubmit" rounded variant="outlined" color="white">수정</v-btn>
                <v-btn @click="cancel" rounded variant="outlined" color="white">취소</v-btn>
            </div>
        </v-form>
    </div>
</template>
